...
<div id="factory-manager-select">
    <ul>
        <li><a href="#"><button>Monitor Factory Performance</button></a></li> <!-- Link to monitor factory performance -->
        ...
        <li><a href="#"><button>Assign Roles</button></a></li> <!-- Link to assign roles -->
